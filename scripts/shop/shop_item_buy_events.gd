...
func buy_first_blue():
	...
	Engine.get_main_loop().current_scene.get_node("/root/Game/CanvasLayer/Control/MarginContainer/PanelContainer/MarginContainer/CollectedResourecesViewer").enable_view(CollectedResources.Types.BLUE)
